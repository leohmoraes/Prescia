...
### Added
- Recorded that maintenance PR #251 was merged and that master SHA `920bbc7f434703194725dd38a1cd5f74adde6fe1` passed the post-merge PHP 8.3, PHP 8.4, PHP 8.5 and PHPStan checks; backlog item 4 remains blocked by the unavailable local PHP/Composer/PHPUnit/PHPStan/Docker toolchain.
- Added `docs/RELATORIO_CICLO_2026-09-26.md`, recording that backlog item 4 remains the first pending but blocked item, the local PHP/Composer/PHPUnit/PHPStan/Docker toolchain is unavailable, no executable legacy DBO call was found in the current administrative/component inventory, open PR #246 was inspected without mixing its independent CSRF batch, and master SHA `12574e3a3982c6898e3f114f549bb16bdae1d185` has completed/successful PHP 8.3, PHP 8.4, PHP 8.5 and PHPStan checks. No functional code, test, PHPStan configuration, baseline or issue change was made.
- Recorded that maintenance PR #249 was merged and that master SHA `74eea614a0d45d7ee3cb077660ef81ac50b8a7af` passed the post-merge PHP 8.3, PHP 8.4, PHP 8.5 and PHPStan checks; backlog item 4 remains blocked by the unavailable local PHP/Composer/PHPUnit/PHPStan/Docker toolchain.
- Added `docs/RELATORIO_CICLO_2026-09-25.md`, recording that backlog item 4 remains the first pending but blocked item, the local PHP/Composer/PHPUnit/PHPStan/Docker toolchain is unavailable, administrative call sites were rechecked without finding executable legacy DBO calls, PR #246 was inspected without mixing its independent failing CSRF batch, and master SHA `2b237056362bbe4436ef9c49f8a2ba3a5957d7b9` has completed/successful PHP 8.3, PHP 8.4, PHP 8.5 and PHPStan checks. No functional code, test, PHPStan configuration, baseline or issue change was made.
- Recorded the merge of maintenance PR #247 and the completed/successful post-merge PHP 8.3, PHP 8.4, PHP 8.5 and PHPStan checks for master SHA `f603a737f0c986473a5b51d6d4f61f76c4d38181`; backlog item 4 remains blocked by the unavailable local PHP/Composer/PHPUnit/PHPStan/Docker toolchain.
- Added `docs/RELATORIO_CICLO_2026-09-24.md`, recording that backlog item 4 remains the first pending but blocked item, the local PHP/Composer/PHPUnit/PHPStan/Docker toolchain is unavailable, open issues and PR #246 were inspected without mixing its independent CSRF batch, and master SHA `8edc15bbfed112d0a082c5d7b00ec5709b4f1eb1` has completed/successful PHP 8.3, PHP 8.4, PHP 8.5 and PHPStan checks. No functional code, test, PHPStan configuration, baseline or issue change was made.
- Added `docs/RELATORIO_CICLO_2026-09-23.md`, recording that backlog item 4 remains the first pending but blocked item, the local PHP/Composer/PHPUnit/PHPStan/Docker toolchain is unavailable, open issues and conflicting pull requests were inspected, and master SHA `02e8a009819cf437c1c83c75ee80b573eabcff54` has completed/successful PHP 8.3, PHP 8.4, PHP 8.5 and PHPStan checks. No functional code, test, PHPStan configuration, baseline or issue change was made.
- Added `docs/RELATORIO_CICLO_2026-09-22.md`, recording that backlog item 4 remains the first pending and blocked item, the local PHP/Composer/PHPUnit/PHPStan/Docker toolchain is unavailable, the open issues and conflicting pull requests were inspected, and documentation PR #243 was merged; final master SHA `de79188f933adc99035eeabcdf59e182c7880c5b` passed post-merge workflows `35693424527` and `35693424752` with completed/successful checks. No functional code or baseline change was made.
- Recorded that maintenance PR #241 was merged and that master SHA `c8a08b8e5533c61b00e9c8b81647002de892d61c` passed post-merge runs `35567054119` and `35567054068`; backlog item 4 remains blocked by the unavailable local toolchain.
...
- Continued PHPStan level-4 remediation in `bi_stats`: corrected the `strpos()` false check, aligned render loops with accumulated result arrays, documented `queryPrepared()` output parameters for both DBO drivers, and added `BiStatsRegressionTest` coverage in PR #227 without baseline expansion.
...
- Consolidated the CKFinder connector into the single `core/ckfinder.php` entrypoint and `core/connector/php/modern` tree for PHP 8.3+, removed the legacy connector mode constant, updated security regression paths, and eliminated obsolete version-gated image extension logic; CI validation is required before merge.
...
- Parameterized UDM virtual-folder values, including tree parents, with metadata-aware types and prepared execution.
