...
### Added
- Added `tests/CsrfTest.php` process coverage and `docs/RELATORIO_ISSUE_240.md` documenting rejection of missing CSRF tokens on mutating methods before application bootstrap continuation; no PHPStan baseline expansion.
