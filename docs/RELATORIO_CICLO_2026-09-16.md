...
Nenhuma PR de código foi aberta e nenhuma PR foi mesclada neste ciclo. O registro documental será publicado em uma branch separada; os checks dessa PR devem ser tratados como evidência documental, não como substituto do toolchain ausente.
