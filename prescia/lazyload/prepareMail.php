<?php // ------------------------ Prescia prepareMail. Will look for $name if cannot find $name_$lang
	...
	$file = "";
	$l = $_SESSION[CONS_SESSION_LANG];
	if (is_file(CONS_PATH_PAGES.$_SESSION['CODE']."/mail/template_$l.html"))
		$file = CONS_PATH_PAGES.$_SESSION['CODE']."/mail/template_$l.html";
	...
	if ($file != "")
		$mail->fetch($file);
	if ($name != "") {
		$innerFile = CONS_PATH_PAGES.$_SESSION['CODE']."/mail/".$name."_$l.html";
